<HTML>
	<HEAD>
		<TITLE> Listagem de Animais Vistos</TITLE>
		<META charset="UTF-8" />
	</HEAD>
	<BODY>
		<?php
		...
		<div style="margin-bottom: 20px;">
		    <A href="animal.php?fun=cadastrarVisto" class="botao-voltar" style="background-color: #76c4df; color: #0a1942; border: none;"> Cadastrar Novo Animal</A>
		...
		<TABLE border="1px">
			...
			<!-- Primeira linha da tabela com o cabeçalho -->
				...
				foreach($lista as $c){	
					...
					echo "<TD><A href='animal.php?fun=exibirVisto&id=". $c->getId() . 
					      "'>" . $c->getNome() . "</A></TD>";
					...
					echo "<TD><A href=animal.php?fun=alterarVisto&id=" . 
					      $c->getId() . "><img src='visao/img/update.png' width='30px'/> 
						  </A></TD>"; 

					echo "<TD><A href=animal.php?fun=excluirVisto&id=" . 
